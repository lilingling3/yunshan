...
class AreaController extends BaseController {
    ...
    /**
     * @Route("/city", methods="POST" ,name="auto_api_2_area_city")
     */
    ...
    public function listAction(Request $req){
        ...
        foreach( $areas as $key=>$value ){
            ...
            $nametemp=$value->getName();
            $str= mb_substr($nametemp,0,3, 'utf-8');

            $py = $pin->Pinyin($str,'UTF8');
            $arr[$key]['pinyin'] = $py;
            $sort[] = $py;
        }
        ...
        foreach($arr as $key => $value){
           ...
           $cityareas =$this->get('auto_manager.area_helper')->getDistinct($value["id"]);
            $cityareas[]=$value["id"];
            ...
            $zimu = strtoupper(substr($value["pinyin"], 0, 1));
