...
/**
 * @Route("/regionDataChart")
 */

class RegionDataChartController extends Controller
{
    /**
     * @Route("/operate", methods="GET", name="auto_admin_region_chart_operate")
     * @Template()
     */
...
//            echo 'order'.count($rentalOrders);
       ...
       //echo '$rental_time'.$rental_time;
        ...
        $cityArr = array();
        $provinceArr = array();
        foreach ($areaTemp as $oArea) {
            $child1 = $oArea->getChildren()->toArray();
            if(empty($child1)){
                $tempArea = $oArea;
                $areaArr[$tempArea->getId()] = array(
                    "id" => $tempArea->getId(),
                    "name" => $tempArea->getName()
                );
                $tempCity = $oArea->getParent();
                $cityArr[$tempCity->getId()] = array(
                    "id" => $tempCity->getId(),
                    "name" => $tempCity->getName()
                );
                $tempProvince = $tempCity->getParent();
                $provinceArr[$tempProvince->getId()] = array(
                    "id" => $tempProvince->getId(),
                    "name" => $tempProvince->getName()
                );
    ...
    /**
     * @Route("/order", methods="GET", name="auto_admin_region_chart_order")
     * @Template()
     */
...
//                    echo $timeStamp;
    ...
    /**
     * @Route("/register", methods="GET", name="auto_admin_region_chart_register")
     * @Template()
     */
...
//                    echo $timeStamp;
    ...
    /**
     * @Route("/identification", methods="GET", name="auto_admin_region_chart_identification")
     * @Template()
     */
