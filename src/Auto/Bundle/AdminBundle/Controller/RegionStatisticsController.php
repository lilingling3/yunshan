...
/**
 * @Route("/regionStatistics")
 */

class RegionStatisticsController extends Controller
{
    /**
     * @Route("/list", methods="GET", name="auto_admin_region_statistics_list")
     * @Template()
     */
    ...
    /**
     * @Route("/amount", methods="GET", name="auto_admin_region_statistics_amount")
     * @Template()
     */
    ...
    /**
     * @Route("/search", methods="POST", name="auto_admin_region_statistics_search")
     * @Template()
     */
    public function statisticsSearchAction(Request $req){
        return $this->redirect(
            $this->generateUrl(
                'auto_admin_region_statistics_amount',
                [
    ...
    /**
     * @Route("/operateSearch", methods="POST", name="auto_admin_region_statistics_operate_search")
     * @Template()
     */
    public function operateSearchAction(Request $req){
        return $this->redirect(
            $this->generateUrl(
                'auto_admin_region_statistics_operate',
                [
    ...
    /**
     * @Route("/operate", methods="GET", name="auto_admin_region_statistics_operate")
     * @Template()
     */
...
//                            echo 'count($dispatchs)'.count($dispatchs);
    ...
    /**
     * @Route("/car/operate", methods="GET", name="auto_admin_region_statistics_car_operate")
     * @Template()
     */
    public function carOperateAction(Request $req){
        ...
        $rentalStations = $qbrs
            ->select('s')
            ->where($qbrs->expr()->in('s.area',$areaIds))
            ->orderBy('s.id', 'DESC')
            ->getQuery()
            ->getResult() ;
...
//            ->findAll();
    ...
    /**
     * @Route("/location", methods="get", name="auto_admin_region_statistics_location")
     * @Template()
     */
...
//                ->findBy(['licensePlate'=>$plate_number],['licensePlace'=>$licensePlace]) ;
    ...
    /**
     * @Route("/car", methods="get", name="auto_admin_region_statistics_car")
     */
    ...
    /**
     * @Route("/getMileageRecords", methods="get", name="auto_admin_region_statistics_mileage_records")
     * @Template()
     */
    ...
    /**
     * @Route("/locationInterface", methods="get", name="auto_admin_region_statistics_locationInterface")
     * @Template()
     */
...
//            );
    ...
    /**
     * @Route("/playBackInterface", methods="get", name="auto_admin_region_statistics_playBackInterface")
     * @Template()
     */
...
//            ->findOneBy(['rentalCar'=>$rentalCar]) ;
    ...
    /**
     * @Route("/operateTwo", methods="GET", name="auto_admin_region_statistics_operate_two")
     * @Template()
     */
...
//            ->findBy(['online' => 1]);
    ...
    /**
     * @Route("/station", methods="GET", name="auto_admin_region_statistics_stations")
     * @Template()
     */
