...
class AlipayNotify {
	...
	function getSignVeryfy($para_temp, $sign) {
		...
		switch (strtoupper(trim(AlipayConfig::SIGN_TYPE))) {
			case "RSA" :
				$isSgin = $alipayRSA->rsaVerify($prestr, trim(AlipayConfig::ALI_PUBLIC_KEY_PATH), $sign);
//                $isSgin = $alipayRSA->rsaVerify($prestr, trim($this->ali_public_key_path), $sign);
				break;
			default :
				$isSgin = false;
		}
	...
	function getResponse($notify_id) {
		...
		$responseTxt = $alipayCore->getHttpResponseGET($veryfy_url, AlipayConfig::CACERT);
