...
class RentalCarType extends AbstractType
{
    /**
    ...
    {
    	if ($options['action'] == '/admin/rentalcar/new' || $options['action'] == '/admin/car/new'){
        	$builder
            ->add('licensePlate','text',['label' => '车牌号'])
            ->add('boxId','text',['label' => '设备号','required' => false])
            ->add('buyPrice','text',['label' => '购买价格（万）','required' => false])
    ...
    {
        return 'auto_bundle_managerbundle_rentalcar';
    }
}
