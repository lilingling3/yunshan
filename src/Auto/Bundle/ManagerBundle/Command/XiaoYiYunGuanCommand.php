...
class XiaoYiYunGuanCommand  extends ContainerAwareCommand{

    public static $serverHost="zp790890874.oicp.net";
    public static $serverPort = "10240" ;
    public static $userId = "000003F3";
    ...
    public static $msg_gnsscenterid = "00000484";  //接入码
    ...
    public static $platform_code = "00000000256";
