...
class CarStartOperateCommand extends ContainerAwareCommand{

    public function configure()
    {
        $this
            ->setName('auto:carstart:operate')
            ->setDescription('car start operate')
            ->addOption('id', 'id', InputOption::VALUE_REQUIRED, 'car start id')
            ->addOption('operate', 'o', InputOption::VALUE_REQUIRED, 'operate option (open close gps status)')
