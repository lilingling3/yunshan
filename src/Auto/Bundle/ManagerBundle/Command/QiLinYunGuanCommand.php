...
class QiLinYunGuanCommand  extends ContainerAwareCommand{
    ...
    public static $msg_gnsscenterid = "00000483";  //接入码
    ...
    public static $platform_code = "00000000255";
