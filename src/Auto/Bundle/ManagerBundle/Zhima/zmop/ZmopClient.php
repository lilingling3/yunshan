...
include('/data/www/yunshan/src/Auto/Bundle/ManagerBundle/Zhima/zmop/RSAUtil.php');
include('/data/www/yunshan/src/Auto/Bundle/ManagerBundle/Zhima/zmop/WebUtil.php');
class ZmopClient {
	//应用ID
	public $appId;
	//私钥文件路径，绝对路径或者相对路径
