$("#page.coupon2.useable .coupon-code").delegate(".button","click",function(){
    var code=$("#page.coupon2.useable .coupon-code .code").val();
    code=code.trim();
    if(code==""){
        alert("请输入兑换码！");
    }
    else{
        $("#page.coupon2.useable .coupon-code .code-inner form").submit();
    }
});
...
$("#page.coupon2.unuseable").delegate(".morecouponbtn","click",function(){
...
$("#page.coupon2.useable").delegate(".morecouponbtn","click",function(){
...
function createcoupon(coupon,flag){
    ...
    var couponstr="&yen;<span class='amount'>"+coupon.amount+"</span>";
