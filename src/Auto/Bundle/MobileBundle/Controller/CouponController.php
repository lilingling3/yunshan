...
class CouponController extends Controller
{
    ...
    /**
     * @Route("/useable/{page}", methods="GET", name="auto_mobile_coupon_useablelist",
     * requirements={"page"="\d+"},
     * defaults={"page"=1})
     * @Template()
     */
    ...
    /**
     * @Route("/unuseable/{page}", methods="GET", name="auto_mobile_coupon_unuseablelist",
     * requirements={"page"="\d+"},
     * defaults={"page"=1})
     * @Template()
     */
    ...
    /**
     * @Route("/draw", methods="post", name="auto_mobile_coupon_draw")
     * @Template()
     */
    public function drawAction(Request $req){
        ...
        if(isset($post_result['errorCode'])&&$post_result['errorCode'] == 0){
            return $this->redirect($this->generateUrl('auto_mobile_coupon_useablelist'));
        }
        else{
            return $this->render(
                "AutoMobileBundle:Default:message.html.twig",
